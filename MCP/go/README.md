# Solar VPS MCP Server

This MCP (Model Content Protocol) server provides access to Solar VPS API functionality through HTTP, HTTPS, and STDIO transport modes.
